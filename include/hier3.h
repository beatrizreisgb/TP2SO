...
/**
 * @brief Função que implementa o algoritmo FIFO para a tabela hierárquica de 3 níveis
...
/**
 * @brief Função que implementa o algoritmo LRU para a tabela hierárquica de 3 níveis
 * @param num_pages Número de páginas
 * @param page_size Tamanho da página
 * @param file Arquivo de entrada
 * @param debug_flag Flag de debug
...
/**
 * @brief Função que implementa o algoritmo RANDOM para a tabela hierárquica de 3 níveis
 * @param num_pages Número de páginas
 * @param page_size Tamanho da página
 * @param file Arquivo de entrada
 * @param debug_flag Flag de debug
...
/**
 * @brief Função que implementa o algoritmo 2a para a tabela hierárquica de 3 níveis
 * @param num_pages Número de páginas
 * @param page_size Tamanho da página
 * @param file Arquivo de entrada
 * @param debug_flag Flag de debug
